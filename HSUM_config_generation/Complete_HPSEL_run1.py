...
dataframe.to_excel('Complete_HPSEL_run1_seed_slope_harmonic_values_summer1.xlsx')
...
for x in AV2:
    ...
    H8.append(x[7])
dataframe=pd.DataFrame({'seeds':seeds1, 'slopes':slopes, 'H1':H1, 'H2':H2, 'H3':H3, 'H4':H4, 'H5':H5, 'H6':H6, 'H7':H7, 'H8':H8})
dataframe.to_excel('Complete_HPSEL_run1_seed_slope_harmonic_values_summer2.xlsx')
