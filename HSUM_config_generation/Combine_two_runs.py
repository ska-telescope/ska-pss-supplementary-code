...
for summer in [0,1]:
    ...
    H8=[]
    for run in [0,1]:            
        df=pd.read_excel('HPSEL_run'+str(run+1)+'_seed_slope_harmonic_values_summer'+str(summer+1)+'.xlsx')
        seed1=run*21
        seed2=seed1+21
...
## Create a new dataframe for the given summer instance and save it to a file
    ...
    df1.to_excel('HPSEL_runs_combined_5slopes_seed_harmonic_values_summer'+str(summer)+'.xlsx')
