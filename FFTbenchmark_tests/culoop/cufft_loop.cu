...
//------- not found on sharabha, perhaps useful for later improvements 
...
//int Narray[]={1024*1024*8,1024*1024*4,1024*1024*2}; [different order helped to identify an earlier error]
...
// initial plan setup is outside of the loop 
...
// cuda has only one plan, not fftw's estimate/measure
