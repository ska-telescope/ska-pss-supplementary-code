...
parser = argparse.ArgumentParser(
    description="Generates convolution filters for acceleration search (developed for PSS-Cheetah)."
)
...
widths = filters(args.num_filters, args.fil_sep).uniform[
    1:
]  ### Widths of filters excluding the 1 bin drift filter.
