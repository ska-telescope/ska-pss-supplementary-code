...
parser = argparse.ArgumentParser(description ='Compares filters from two filtersets. Plots amplitude and phase of the filters. Repositiory has three set of fitlers, generated by MATLAB script, CPP script, and this python code.')

parser.add_argument('-filterset1',
                    type = str,
                    required = True,
                    help ='filename of first set of filters.')

parser.add_argument('-filterset2',
                    type = str,
                    required = True,
                    help ='filename of second set of filters.')
